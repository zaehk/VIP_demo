...
struct BelongsToCollectionResponseModel: Codable {
    let id: Int?
...
struct ProductionCompanyResponseModel: Codable {
    let id: Int?
    let logoPath: String?
...
struct ProductionCountryResponseModel: Codable {
...
// MARK: - SpokenLanguage
struct SpokenLanguageResponseModel: Codable {
